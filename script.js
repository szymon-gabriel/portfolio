...
const translations = {
    pl: {
        ...
        p0_desc: "Aplikacja mobilna i PWA do śledzenia nawyków, wygenerowana jako natywna paczka Android za pomocą Capacitora.",
    ...
    en: {
        ...
        p0_desc: "Mobile & PWA habit tracking application, compiled into a native Android package using Capacitor.",
